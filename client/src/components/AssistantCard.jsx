...
export default function AssistantCard({ userName }) {
  ...
  return (
    <div className="rounded-3xl bg-white/85 dark:bg-white/[0.06] backdrop-blur-xl shadow-[0_8px_30px_rgba(124,111,240,0.12)] border border-white/60 dark:border-white/10 p-5 flex flex-col h-[420px]">
      {/* Header */}
