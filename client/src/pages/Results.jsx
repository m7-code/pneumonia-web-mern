      ...
      <div className="relative z-10">
        ...
        <main className="mx-auto max-w-5xl px-5 md:px-8 pt-10 pb-20">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:h-[560px]">
            {/* LEFT: Upload */}
            <div className="glass-card tint-purple rounded-3xl p-5 flex flex-col h-full overflow-hidden">
              <h2 className="relative z-[2] font-display font-bold text-ink dark:text-white mb-3 text-sm shrink-0">
                Upload X-Ray
              </h2>
              ...
              <div
                ...
                onDrop={handleDrop}
                className={`relative z-[2] flex-1 min-h-0 rounded-2xl border-2 border-dashed overflow-hidden flex flex-col items-center justify-center cursor-pointer transition-colors ${
              ...
              {error && (
                <div className="relative z-[2] mt-3 rounded-xl bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 text-red-600 dark:text-red-400 text-sm px-4 py-2 shrink-0">
                  {error}
                </div>
              )}
              ...
              <button
                ...
                className="glossy-btn relative z-[2] mt-4 rounded-full text-white font-semibold text-sm uppercase tracking-wider py-3 transition-transform hover:-translate-y-0.5 disabled:opacity-40 disabled:translate-y-0 shrink-0"
                style={{
              ...
              >
                <span className="relative z-[2]">{loading ? 'Analyzing...' : 'Analyze X-Ray'}</span>
              </button>
            </div>

            {/* RIGHT: Results */}
            <div className="glass-card tint-pink rounded-3xl p-5 flex flex-col h-full overflow-hidden">
              <h2 className="relative z-[2] font-display font-bold text-ink dark:text-white mb-3 text-sm shrink-0">
                Result
              </h2>

              {!result ? (
                <div className="relative z-[2] flex-1 flex items-center justify-center text-center text-muted text-sm">
                  Upload an X-ray to see the screening result here.
                </div>
              ) : (
                <div className="relative z-[2] flex-1 min-h-0 flex flex-col gap-4 overflow-y-auto pr-1">
